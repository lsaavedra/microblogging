...
func TestFollowsDB_UserFollowingAnotherUserSuccess(t *testing.T) {
	...
	mock.ExpectExec(regexp.QuoteMeta(
		`INSERT INTO "follows" ("followed_id","follower_id","followed_at") VALUES ($1,$2,$3)`,
	)).WithArgs(
		targetUserID,
		userID,
		sqlmock.AnyArg()).
	...
	err := repo.CreateFollowing(context.TODO(), model.Follow{FollowedID: targetUserID, FollowerID: userID})
